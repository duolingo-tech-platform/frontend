        ...
        >
          ...
          >
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Junte-se a mais de 12 mil alunos aprendendo tecnologia.</Text>
            </View>

            {/* Pills */}
            <View style={styles.pillsRow}>
              <View style={styles.pill}><Text style={styles.pillText}>🚀 Grátis para começar</Text></View>
              <View style={styles.pill}><Text style={styles.pillText}>🎮 Gamificado</Text></View>
            </View>
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity style={styles.termsRow} activeOpacity={0.7} onPress={() => setTermsAccepted(!termsAccepted)}>
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingHorizontal: 24, paddingTop: 60, paddingBottom: 40, gap: 28,
  },
  ...
  pillText: { color: '#43e97b', fontSize: 12, fontWeight: '600' },
  ...
  checkboxChecked: { backgroundColor: '#43e97b', borderColor: '#43e97b' },
  checkmark: { fontSize: 13, color: '#010d19', fontWeight: '800' },
  termsText: { flex: 1, fontSize: 13, color: '#5a7a8a', lineHeight: 20 },
  termsLink: { color: '#43e97b', fontWeight: '600' },
  ...
  loginRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  loginText: { fontSize: 14, color: '#5a7a8a' },
  loginLink: { fontSize: 14, color: '#43e97b', fontWeight: '700' },
});
